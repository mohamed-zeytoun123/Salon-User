...
class CosmeticItemNearestCardWidget extends StatelessWidget {
  final CosmeticItemModelDUMMY item;
  final NearestModel model;

  const CosmeticItemNearestCardWidget({
    super.key,
    required this.item,
    required this.model,
  });
          ...
          Positioned(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(model.address.region.city.name,
